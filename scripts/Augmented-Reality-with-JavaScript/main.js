$(function () {
	...
	$('#container').append('<p style="font-size: small; text-align: center; margin-top: 0">[<a href="http://molecules3d.apphb.com/">Large Version</a>] [<a href="https://github.com/ianreah/Molecules3D">View on GitHub</a>]</p>');
	...
	$.getJSON('/scripts/Augmented-Reality-with-JavaScript/caffeine.json', function (data) {
